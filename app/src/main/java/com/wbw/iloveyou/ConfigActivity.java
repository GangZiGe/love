...
public class ConfigActivity extends Activity{
			...
			public void onClick(View v) {
				...
				if(Boolean.valueOf(firstconfig)){
					if(PointsManager.getInstance(mContext).spendPoints(20)){           
				        //Log.d("test","������100����");
					 	Toast.makeText(mContext, "�״α�������20���֣�ֻ���Ĵ�һ�Σ��˺����������",
					 			Toast.LENGTH_LONG).show();
					 	spxml.setConfigSharedPreferences("firstconfig", "false");
				    }else{
				        //Log.d("text","���ѻ���ʧ��(��������)");
				    	Toast.makeText(mContext, "�״α���������20���֣�ֻ���Ĵ�һ�Σ��˺���������֣�" +
				    			"�����ֲ���������ʧ��",
					 			Toast.LENGTH_LONG).show();
				    	return;
				    }   
	...
	private void downApk(){
		...
		try {
			cur = getCurrentVersionName();
			if(cur.equals(info.getVersionCode())){ 
				Toast.makeText(mContext, "�汾��ͬ����������", Toast.LENGTH_SHORT).show();
			}else{
				//����
				...
				current_version.setText("��ǰ�汾�ǣ�"+cur);
	...
	/**
	 * �ӷ�������ȡ�����µ�APK�ŵ�/sdcard/YongJingSmartHome/updata.apk��Comments����
	 * @param path ΪUpdataInfo��ApkUrl
	 * @param pd
	 * @return
	 * @throws Exception
	 */
